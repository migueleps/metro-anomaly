...
from TCN_AAE import Encoder_TCN, Decoder_TCN, LSTMDiscriminator_TCN
    ...
    with th.no_grad():
        ...
        with tqdm.tqdm(test_tensors, unit="cycles") as tqdm_epoch:
            for test_tensor in tqdm_epoch:
                ...
                latent_space = args.encoder(test_tensor)
...
def load_parameters(arguments):
    ...
    arguments.MODEL_NAME = "LSTMDiscriminator_TCN"
    ...
    arguments.encoder = Encoder_TCN(arguments.NUMBER_FEATURES,
                                    arguments.EMBEDDING,
                                    arguments.DROPOUT,
                                    arguments.LSTM_LAYERS,
                                    hidden_dim=arguments.tcn_hidden,
    ...
    arguments.discriminator = LSTMDiscriminator_TCN(arguments.EMBEDDING,
                                                    arguments.DROPOUT,
                                                    n_layers=arguments.disc_layers,
                                                    disc_hidden=arguments.disc_hidden).to(arguments.device)
