...
def load_parameters(arguments):
    ...
    arguments.results_string = lambda loop_no: f"{arguments.results_folder}{loop_no}_losses_{arguments.model_string('WAE')}_{arguments.EPOCHS}_{arguments.LR}_{arguments.BATCH_SIZE}.pkl"
